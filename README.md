...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/rchong26-code/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/rchong26-code/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/rchong26-code/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/rchong26-code/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/rchong26-code/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/rchong26-code/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |             18m 12s              |           1m 32s                | 
| `pg_normalized_batch`  |             1m 27s             |             0m 16s              | 
| `pg_denormalized`      |              18s             |                3s           | 
